...
urlpatterns = [
    ...
    url('remove_unconfirmed_openid/(?P<openid_id>\d+)', RemoveUnconfirmedOpenIDView.as_view(), name='remove_unconfirmed_openid'),
    url('remove_confirmed_openid/(?P<openid_id>\d+)', RemoveConfirmedOpenIDView.as_view(), name='remove_confirmed_openid'),
    url('openid_redirection/(?P<openid_id>\d+)', RedirectOpenIDView.as_view(), name='openid_redirection'),
    url('confirm_openid/(?P<openid_id>\w+)', ConfirmOpenIDView.as_view(), name='confirm_openid'),
